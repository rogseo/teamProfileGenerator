                ...
                <div class="card" style="width: 18rem;">
                  ...
                  <div class="card-body">
                    <ul class="list-group list-group-flush">
                      ...
                      <li class="list-group-item">Email : <a href="mailto:${employee[i].email}">${employee[i].email}</a></li>
                ...
                <div class="card" style="width: 18rem;">
                  ...
                  <div class="card-body">
                    <ul class="list-group list-group-flush">
                      <li class="list-group-item">ID : ${employee[i].id}</li>
                      <li class="list-group-item">Email : <a href="mailto:${employee[i].email}">${employee[i].email}</a></li>
                      <li class="list-group-item">Github : <a href="https://www.github.com/${employee[i].github}">${employee[i].github}</a></li>
                    </ul>
                  </div>        
                </div>
              </section>`; break;
